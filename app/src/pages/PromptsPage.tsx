...
const OPERATION_GROUPS = {
  'Генерация': ['generate_cjm', 'generate_business_canvas', 'generate_lean_canvas', 'generate_roadmap'],
  'Анализ': ['analyze_cjm', 'analyze_business_canvas', 'analyze_lean_canvas', 'analyze_roadmap'],
