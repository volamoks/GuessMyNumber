...
export interface UnifiedExportActionsProps {
  ...
  /** Copy as Slide Markdown action */
  onCopySlides?: ExportAction
  /** Layout direction */
  layout?: 'row' | 'column'
...
export function UnifiedExportActions({
  ...
  return (
    <div className={`${wrapperClass} ${className}`}>
      {onCopySlides && (
        <LoadingButton
          label={onCopySlides.label || 'Copy for Slides'}
          loadingLabel={onCopySlides.loadingLabel || 'Copying...'}
          icon={FileDown}
          isLoading={onCopySlides.isLoading}
          onClick={onCopySlides.onClick}
          variant="outline"
          size="sm"
        />
      )}
