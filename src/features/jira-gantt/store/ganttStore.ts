...
import type { GanttTask, JiraConfig, ConnectionStatus, JiraQuery } from '@/features/jira-gantt/types'
import type { GanttColumn, TimeScale } from '@/features/jira-gantt/components/types'
